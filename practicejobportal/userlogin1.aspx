<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userlogin1.aspx.cs" Inherits="practicejobportal.userlogin1" %>
...
&nbsp;
                        <asp:Button ID="Button2" runat="server" CssClass="auto-style8" Height="48px" Text="Register" Width="153px" OnClick="Button2_Click" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server">Dont you have acount ?? register</asp:HyperLink>
    </form>
</body>
</html>
